...
import { Plus, AlertTriangle, Users, MoreHorizontal, Pencil, Ban, CheckCircle } from 'lucide-react';
...
export default function CaseCategories({ abuseTypes, referralPartners }: CaseCategoriesProps) {
    ...
    const openEditAbuse = (item: AbuseType) => {
        ...
        abuseForm.setData({
            ...
            description: '' // Add description if available in model
        });
        setIsAbuseModalOpen(true);
    };
