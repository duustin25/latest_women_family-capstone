...
export default function ReviewSoloParent({ application }: { application: any }) {
    ...
    return (
        <AppLayout breadcrumbs={[{ title: 'Queue', href: '/admin/applications' }, { title: 'Review Solo Parent', href: '#' }]}>
                    ...
                    <div className="bg-white dark:bg-slate-900 shadow-2xl border border-slate-200 dark:border-slate-700">
                        ...
                        <div className="p-8">
                            ...
                            <div className="border-t border-l border-slate-300 dark:border-slate-600 grid grid-cols-12 text-slate-900 dark:text-slate-100">
                                ...
                                {/* Solo Parents usually have extra fields, but for now generic dynamic render */}
