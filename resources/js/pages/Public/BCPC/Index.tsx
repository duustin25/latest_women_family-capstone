                ...
                <div className="container mx-auto px-6 py-16 space-y-20">
                    ...
                    <section>
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            <Card className="border-t-4 border-t-sky-500 shadow-sm hover:shadow-md transition-shadow">
                                <CardHeader>
                                    <div className="w-12 h-12 bg-sky-50 rounded-full flex items-center justify-center mb-4">
                                        <Scale className="w-6 h-6 text-sky-600" />
                                    </div>
                                    <CardTitle className="uppercase font-black text-lg text-slate-900">Diversion Programs</CardTitle>
                                </CardHeader>
                                <CardContent>
                            ...
                            <Card className="border-t-4 border-t-amber-500 shadow-sm hover:shadow-md transition-shadow">
                                <CardHeader>
                                    ...
                                    <CardTitle className="uppercase font-black text-lg text-slate-900">Intervention (CAR)</CardTitle>
                                </CardHeader>
                                <CardContent>
                                    <p className="text-slate-600 text-sm leading-relaxed">
                            ...
                            <Card className="border-t-4 border-t-emerald-500 shadow-sm hover:shadow-md transition-shadow">
                                <CardHeader>
                                    ...
                                    <CardTitle className="uppercase font-black text-lg text-slate-900">Rehabilitation</CardTitle>
                                </CardHeader>
                                <CardContent>
                                    <p className="text-slate-600 text-sm leading-relaxed">
                    ...
                    {/* --- INTERVENTION PROCESS --- */}
                    <section id="intervention-process" className="bg-slate-50 rounded-2xl p-8 md:p-12 border border-slate-200">
                        <div className="flex items-center gap-3 mb-10">
                            <Baby className="text-sky-600 w-8 h-8" />
                            <h2 className="text-3xl font-black text-slate-900 uppercase tracking-tight">Intervention Process</h2>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                            {[
                                ...
                                <div key={index} className="relative pl-8 md:pl-0 pt-0 md:pt-12 group">
                                    <div className="hidden md:block absolute top-0 left-0 w-full h-1 bg-slate-200 group-hover:bg-sky-400 transition-colors"></div>
                                    <div className="absolute md:top-[-6px] left-[-5px] md:left-0 w-3 h-3 bg-sky-600 rounded-full"></div>
                                    <div className="md:hidden absolute left-0 top-0 h-full w-1 bg-slate-200 group-hover:bg-sky-400 transition-colors"></div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                        ...
                        <section>
                            <div className="flex items-center gap-2 mb-6">
                                ...
                                <h2 className="text-2xl font-black text-slate-900 uppercase tracking-tight">Signs of Abuse</h2>
                            </div>
                            <ul className="space-y-4">
                                {[
                                    ...
                                    <li key={i} className="flex items-start gap-4 p-4 bg-white border border-slate-100 rounded-lg shadow-sm hover:border-amber-200 transition-colors">
                                        <div className="w-6 h-6 rounded-full bg-amber-100 flex items-center justify-center shrink-0 mt-0.5">
                                            <AlertCircle className="w-4 h-4 text-amber-600" />
                                        </div>
                                        <div>
                                            <strong className="block text-slate-900 font-bold text-sm uppercase mb-1">{sign.title}</strong>
                                            <span className="text-slate-600 text-sm leading-snug">{sign.desc}</span>
                                        </div>
                                    </li>
                                ))}
                            </ul>
                        ...
                        <section>
                            <div className="flex items-center gap-2 mb-6">
                                ...
                                <h2 className="text-2xl font-black text-slate-900 uppercase tracking-tight">Rights of the Child (PD 603)</h2>
                            </div>
                            <Accordion type="single" collapsible className="w-full">
                                <AccordionItem value="item-1" className="border-b-slate-200">
                                    <AccordionTrigger className="uppercase font-bold text-sm hover:text-sky-600">Right to be Born Well</AccordionTrigger>
                                ...
                                <AccordionItem value="item-2" className="border-b-slate-200">
                                    <AccordionTrigger className="uppercase font-bold text-sm hover:text-sky-600">Right to Protection</AccordionTrigger>
                                    <AccordionContent className="text-slate-600 leading-relaxed">
                                ...
                                <AccordionItem value="item-3" className="border-b-slate-200">
                                    <AccordionTrigger className="uppercase font-bold text-sm hover:text-sky-600">Who is a Child in Conflict with the Law (CICL)?</AccordionTrigger>
                                    <AccordionContent className="text-slate-600 leading-relaxed">
                                ...
                                <AccordionItem value="item-4" className="border-b-slate-200">
                                    <AccordionTrigger className="uppercase font-bold text-sm hover:text-sky-600">What is the Minimum Age of Responsibility?</AccordionTrigger>
                                    <AccordionContent className="text-slate-600 leading-relaxed">
