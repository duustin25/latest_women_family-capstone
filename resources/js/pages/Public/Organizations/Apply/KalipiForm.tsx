...
// import { toast } from "sonner"; // Kept for error handling
// import DynamicForm from './DynamicForm';

// export default function KalipiForm({ organization, mode = 'public' }: { organization: any, mode: string }) {
...
//     const backUrl = mode === 'admin' ? '/admin/applications/create' : `/organizations/${organization.slug}`;
//     const backLabel = mode === 'admin' ? 'Back to Selection' : 'Back to Profile';
...
//                 });
//             }
//             // Note: Success toast is now handled by the Layout flash listener
//         });
//     };
...
//                     </Link>
//                     {mode === 'admin' && <Badge className="bg-amber-500 text-white font-black px-3 py-1 rounded-none text-[9px] uppercase tracking-widest shadow-lg">Encoder Mode</Badge>}
//                 </div>
...
//                                     <Input type="date" required onChange={e => setData('personal_data', { ...data.personal_data, dob: e.target.value })} className="border-0 border-b-2 rounded-none bg-transparent h-10 px-0 font-bold dark:text-white" />
//                                 </div>
//                                 <div className="md:col-span-2 space-y-2">
//                                     <Label className="uppercase text-[10px] font-black text-slate-400">Age</Label>
//                                     <Input type="number" onChange={e => setData('personal_data', { ...data.personal_data, age: e.target.value })} className="border-0 border-b-2 rounded-none bg-transparent h-10 px-0 font-bold dark:text-white" />
//                                 </div>
//                                 <div className="md:col-span-3 space-y-2">
//                                     <Label className="uppercase text-[10px] font-black text-slate-400">Religion</Label>
//                                     <Input onChange={e => setData('personal_data', { ...data.personal_data, religion: e.target.value.toUpperCase() })} className="border-0 border-b-2 rounded-none bg-transparent h-10 px-0 font-bold dark:text-white" />
//                                 </div>
//                                 <div className="md:col-span-4 space-y-2">
//                                     <Label className="uppercase text-[10px] font-black text-slate-400">Civil Status</Label>
//                                     <select className="w-full border-0 border-b-2 rounded-none bg-transparent focus:ring-0 h-10 font-bold uppercase text-xs dark:text-white" onChange={e => setData('personal_data', { ...data.personal_data, civil_status: e.target.value })}>
...
//                                     <Input placeholder="Indicate if applicable..." onChange={e => setData('personal_data', { ...data.personal_data, sectoral_category: e.target.value.toUpperCase() })} className="border-0 border-b-2 rounded-none h-10 px-0 font-bold dark:text-white" />
//                                 </div>
//                                 <div className="md:col-span-6 space-y-2">
...
//                                     <Input onChange={e => setData('personal_data', { ...data.personal_data, education: e.target.value.toUpperCase() })} className="border-0 border-b-2 rounded-none h-10 px-0 font-bold dark:text-white" />
//                                 </div>
//                                 <div className="md:col-span-4 space-y-2">
//                                     <Label className="uppercase text-[10px] font-black text-slate-400 italic">Occupation</Label>
//                                     <Input onChange={e => setData('personal_data', { ...data.personal_data, occupation: e.target.value.toUpperCase() })} className="border-0 border-b-2 rounded-none h-10 px-0 font-bold dark:text-white" />
//                                 </div>
//                                 <div className="md:col-span-3 space-y-2">
//                                     <Label className="uppercase text-[10px] font-black text-slate-400 italic">Monthly Income</Label>
//                                     <Input type="number" placeholder="0.00" onChange={e => setData('personal_data', { ...data.personal_data, monthly_income: e.target.value })} className="border-0 border-b-2 rounded-none h-10 px-0 font-bold dark:text-white" />
//                                 </div>
//                                 <div className="md:col-span-5 space-y-2">
//                                     <Label className="uppercase text-[10px] font-black text-slate-400 italic">Skills / Hobbies</Label>
//                                     <Input onChange={e => setData('personal_data', { ...data.personal_data, skills: e.target.value.toUpperCase() })} className="border-0 border-b-2 rounded-none h-10 px-0 font-bold dark:text-white" />
//                                 </div>
//                             </div>
...
//                                 setData={(field, value) => setData('personal_data', { ...data.personal_data, [field]: value })}
//                                 errors={errors}
//                             />
...
//                                     <Input onChange={e => setData('personal_data', { ...data.personal_data, company: { ...data.personal_data.company, name: e.target.value.toUpperCase() } })} className="h-8 text-xs font-bold uppercase border-slate-200" />
//                                 </div>
//                                 <div className="space-y-2">
...
//                                     <Input onChange={e => setData('personal_data', { ...data.personal_data, company: { ...data.personal_data.company, address: e.target.value.toUpperCase() } })} className="h-8 text-xs font-bold uppercase border-slate-200" />
//                                 </div>
//                                 <div className="space-y-2">
//                                     <Label className="text-[9px] font-black uppercase text-slate-400 flex items-center gap-2"><Phone size={12} /> Telephone No.</Label>
//                                     <Input onChange={e => setData('personal_data', { ...data.personal_data, company: { ...data.personal_data.company, tel: e.target.value } })} className="h-8 text-xs font-bold border-slate-200" />
//                                 </div>
//                             </div>
//                         </section>
...
//                                 {processing ? 'Finalizing...' : (mode === 'admin' ? 'Register Manual Entry' : 'Authorize & Submit Form')}
//                             </Button>
