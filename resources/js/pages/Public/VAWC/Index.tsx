                            ...
                            <ul className="space-y-4">
                                {[
                                    ...
                                    <li key={i} className="flex items-start gap-4 p-4 bg-white dark:bg-neutral-900 border border-slate-100 dark:border-neutral-800 rounded-lg shadow-sm hover:border-rose-200 dark:hover:border-rose-900 transition-colors">
                                        <div className="w-6 h-6 rounded-full bg-rose-100 dark:bg-rose-900/30 flex items-center justify-center shrink-0 mt-0.5">
                                            <span className="text-rose-700 dark:text-rose-400 font-bold text-xs">{i + 1}</span>
                                        </div>
                                        <span className="text-slate-700 dark:text-slate-300 font-medium text-sm">{req}</span>
                                    </li>
                                ))}
                            </ul>
                        </section>
